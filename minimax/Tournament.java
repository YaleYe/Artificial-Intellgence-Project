...
public class Tournament {
	...
	// new Contestant(MattB.getPlayer(), "Matt"),
	// new Contestant(StephanieC.getPlayer(), "Stephanie"),
	// new Contestant(JessicaD.getPlayer(), "Jessica"),
	// new Contestant(RiverE.getPlayer(), "River"),
	// new Contestant(TeseanF.getPlayer(), "Tesean"),
	// new Contestant(RahulG.getPlayer(), "Rahul"),
	// new Contestant(NoahG.getPlayer(), "Noah"),
	// new Contestant(FletcherH.getPlayer(), "Fletcher"),
	// new Contestant(AidanH.getPlayer(), "Aidan"),
	// new Contestant(HarleighN.getPlayer(), "Harleigh"),
	// new Contestant(ElijahK.getPlayer(), "Elijah"),
	// new Contestant(JacobS.getPlayer(), "Jacob"),
	// new Contestant(RyanS.getPlayer(), "Ryan"),
	// new Contestant(GuriqbalS.getPlayer(), "Guriqbal"),
	// new Contestant(IsiashV.getPlayer(), "Isiash"),
	// new Contestant(MarkW.getPlayer(), "Mark"),
	new Contestant(YihongY.getPlayer(), "Yihong"),
	//new Contestant(DinghengZ.getPlayer(), "Dingheng"),
    };
